...
buttonsSTRUCT klawisze[16]={
  ...
  2, 3, "Pogoda",      toggle_event_handler3, NULL,
...
static void DRAW_buttons_alarmy(lv_event_t * e)
  {
    lv_event_code_t code = lv_event_get_code(e);
    Serial.print("dddddddddddddDRAW_buttons_alarmy code=");Serial.println(code);
    //updateButtons(MENU_MAIN, 0, 16);
...
/*bbbbbbbbbbbbbbbbb*/
static void updateButtons(int8_t menu, int8_t startRow, int8_t ctn){
  //Serial.println("updateButtons=====");Serial.println(menu);
    ...
    for (int8_t i=0; i<ctn;i++)  {
      ...
      if (menu == MENU_ALARMY){
          //Serial.print(i);Serial.print(" = ");Serial.println(alarmy[i].labelka);
      ...
      if (menu == MENU_MAIN){
        //Serial.print(i);Serial.print(" = ");Serial.println(klawisze[i].labelka);
